...
5. Select the language of the reviews you want to scrape
6. Select the number of reviews you want to scrap (to get all just take a really high number)
7. Press `Scrape Reviews`
